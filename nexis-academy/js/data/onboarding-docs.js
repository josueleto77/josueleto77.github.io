...
window.ONBOARDING_DOCS = {
  w2_employee: [
    ...
    { key: 'w4', label: 'IRS Form W-4', category: 'Federal Tax' },
    { key: 'm4', label: 'Massachusetts Form M-4', category: 'Massachusetts Tax' },
    { key: 'direct_deposit', label: 'Payroll / Direct Deposit Setup', category: 'Payroll' },
    { key: 'employment_agreement', label: 'Nexis Power Employment Agreement', category: 'Company Agreements' },
  ...
  '1099_contractor': [
    { key: 'w9', label: 'IRS Form W-9', category: 'Tax' },
    { key: 'contractor_agreement', label: 'Independent Contractor Agreement', category: 'Company Agreements' },
    ...
    { key: 'payment_setup', label: 'Payment Method Setup (QuickBooks)', category: 'Payment' }
  ]
};
